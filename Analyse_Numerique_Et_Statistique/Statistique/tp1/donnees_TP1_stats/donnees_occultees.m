...
M = zeros(50,2);
if theta_1 < theta_2
    I = find( theta_donnees_bruitees > theta_1 & theta_donnees_bruitees < theta_2 );
else
    I = find( (theta_donnees_bruitees > 0 & theta_donnees_bruitees < theta_1) | (theta_donnees_bruitees > theta_1 & theta_donnees_bruitees < 2*pi));
end
 x_donnees_bruitees = x_donnees_bruitees(I);
 y_donnees_bruitees = y_donnees_bruitees(I);
