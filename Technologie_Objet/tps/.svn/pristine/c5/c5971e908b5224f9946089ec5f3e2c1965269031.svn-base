...
public class Menu implements Commande {
	...
	private Mode mode; // un élément de l'énumération
	 ...
	 */
	//@ ensures this.getMode() == Mode.REMANANT;
	public void setRemanant() {
		this.mode = Mode.REMANANT;
	}
	
	/** Rendre le menu volatil.*/
	//@ ensures this.getMode() == Mode.VOLATIL;
	...
	public void valider() {
		...
		/** Gérer le menu. Cela consiste à afficher le menu, sélectionner
		 ...
		 * (il dipsarait après la première sélection valide).
		 */
		public void gerer() {
			do {
