...
public class Segment {
	...
	*/
	 ...
	 */
	public void dessiner(java.lang.String titre, int l, int h, int pxl, Color couleur) {
		Ecran Ec = new Ecran(titre, l, h, pxl);
		Ec.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), couleur);
