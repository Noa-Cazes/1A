function [TEB] = Ch4ASK(alpha, Rb, Eb_N0_dB, display)
%Ch4ASK Cha�ne de transmission avec modulation 4-ASK
...
%       g�n�r� et le message binaire obtenu
    ...
    %% CONSTELLATION
    constellation(mapping, signalE, '4-ASK'); 
