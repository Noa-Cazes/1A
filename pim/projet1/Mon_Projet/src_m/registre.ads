...
package registre is
    ...
    -- Paramètres
    --     	Data  : Data est la structure de donnéées contenant toutes les informations.
    function Get_Birthday (Data : in T_Donnee) return Integer;
    ...
    -- Type_De_Retour : Integer est la date de decés de l'individu.
    -- Paramètres
    --     	Data  : Data est la structure de donnéées contenant toutes les informations.
    function Get_Deathday (Data : in T_Donnee) return Integer;


    -- Nom 	      : Get_Deathplace
    -- Sémantique     : Obtenir le lieu de decés d'un individu.
    -- Type_De_Retour : Integer est le lieu de decés de l'individu.
    -- Paramètres
    --     	Data  : Data est la structure de donnéées contenant toutes les informations.
    ...
    -- Nom 	      : Get_Cohabitant_ID
    -- Sémantique     : Obtenir l'ID du concubain d'un individu.
    -- Type_De_Retour : Integer est l'ID du concubain de l'individu.
    -- Paramètres
    --     	Data  : Data est la structure de donnéées contenant toutes les informations.
    function Get_Cohabitant_ID (Data : in T_Donnee) return Integer;


    -- Nom 	      : Get_Age
    -- Sémantique     : Obtenir l'age d'un individu.
    -- Type_De_Retour : Integer est l'age de l'individu.
    -- Paramètres
    --     	Data  : Data est la structure de donnéées contenant toutes les informations.
    function Get_Age (Data : in T_Donnee) return Integer;
