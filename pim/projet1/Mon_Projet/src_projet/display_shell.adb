...
package body Display_Shell is
    ...
    begin
        ...
        Put_Line ("Date de Naissance : " & Integer'Image (Get_Birthday (Donnee)));
        Put_Line ("Lieu de Naissance : " & Get_Birthplace (Donnee));
        Put_Line ("Date de Décès : " & Integer'Image (Get_Deathday (Donnee)));
        ...
        Put_Line ("Concubain : " & Integer'Image (Get_Cohabitant_ID (Donnee)));
        Put_Line("Age : " & Integer'Image (Get_Age (Donnee)));
    end Afficher_Donnee;
