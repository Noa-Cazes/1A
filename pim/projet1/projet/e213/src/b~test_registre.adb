pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_registre.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_registre.adb");
...
package body ada_main is
   ...
   E139 : Short_Integer; pragma Import (Ada, E139, "system__assertions_E");
   E141 : Short_Integer; pragma Import (Ada, E141, "system__pool_global_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "registre_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_registre");
