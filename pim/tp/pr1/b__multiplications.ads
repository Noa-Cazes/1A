...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_multiplications" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#548118bc#;
   pragma Export (C, u00001, "multiplicationsB");
   ...
   u00005 : constant Version_32 := 16#6feb5362#;
   ...
   u00098 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00098, "system__os_primitivesB");
   u00099 : constant Version_32 := 16#41c889f2#;
   pragma Export (C, u00099, "system__os_primitivesS");
   u00100 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00100, "ada__integer_text_ioB");
   u00101 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00101, "ada__integer_text_ioS");
   ...
   u00114 : constant Version_32 := 16#ec083f01#;
   ...
   u00120 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00120, "ada__text_io__integer_auxB");
   u00121 : constant Version_32 := 16#2fe01d89#;
   ...
   u00124 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00124, "system__img_biuB");
   u00125 : constant Version_32 := 16#b49118ca#;
   pragma Export (C, u00125, "system__img_biuS");
   u00126 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00126, "system__img_llbB");
   u00127 : constant Version_32 := 16#f5560834#;
   ...
   u00130 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00130, "system__img_llwB");
   u00131 : constant Version_32 := 16#5c3a2ba2#;
   pragma Export (C, u00131, "system__img_llwS");
   u00132 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00132, "system__img_wiuB");
   u00133 : constant Version_32 := 16#dad09f58#;
   pragma Export (C, u00133, "system__img_wiuS");
   u00134 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00134, "system__val_intB");
   u00135 : constant Version_32 := 16#f3ca8567#;
   pragma Export (C, u00135, "system__val_intS");
   u00136 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00136, "system__val_unsB");
   u00137 : constant Version_32 := 16#47b5ed3e#;
   ...
   u00145 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00145, "system__img_lldB");
   u00146 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00146, "system__img_lldS");
   u00147 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00147, "system__img_decB");
   u00148 : constant Version_32 := 16#e818e5df#;
   pragma Export (C, u00148, "system__img_decS");
