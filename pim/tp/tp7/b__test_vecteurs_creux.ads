...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#8fe804de#;
   ...
   u00115 : constant Version_32 := 16#8bb8c090#;
   pragma Export (C, u00115, "system__assertionsS");
   u00116 : constant Version_32 := 16#68abf432#;
   pragma Export (C, u00116, "vecteurs_creuxB");
   u00117 : constant Version_32 := 16#6db7622a#;
   pragma Export (C, u00117, "vecteurs_creuxS");
   u00118 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00118, "ada__float_text_ioB");
   u00119 : constant Version_32 := 16#39060f6c#;
   pragma Export (C, u00119, "ada__float_text_ioS");
   u00120 : constant Version_32 := 16#25afee5b#;
   pragma Export (C, u00120, "ada__text_io__float_auxB");
   u00121 : constant Version_32 := 16#6ecdea4c#;
   pragma Export (C, u00121, "ada__text_io__float_auxS");
   u00122 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00122, "ada__text_io__generic_auxB");
   u00123 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00123, "ada__text_io__generic_auxS");
   ...
   u00131 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00131, "system__powten_tableS");
   u00132 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00132, "system__val_realB");
   u00133 : constant Version_32 := 16#484a00d1#;
   pragma Export (C, u00133, "system__val_realS");
   u00134 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00134, "system__exn_llfB");
   u00135 : constant Version_32 := 16#fa4b57d8#;
   pragma Export (C, u00135, "system__exn_llfS");
   u00136 : constant Version_32 := 16#1e40f010#;
   pragma Export (C, u00136, "system__fat_fltS");
   u00137 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00137, "ada__integer_text_ioB");
   u00138 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00138, "ada__integer_text_ioS");
   u00139 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00139, "ada__text_io__integer_auxB");
   u00140 : constant Version_32 := 16#2fe01d89#;
   pragma Export (C, u00140, "ada__text_io__integer_auxS");
   u00141 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00141, "system__img_biuB");
   u00142 : constant Version_32 := 16#b49118ca#;
   pragma Export (C, u00142, "system__img_biuS");
   u00143 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00143, "system__img_llbB");
   u00144 : constant Version_32 := 16#f5560834#;
   pragma Export (C, u00144, "system__img_llbS");
   u00145 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00145, "system__img_lliB");
   u00146 : constant Version_32 := 16#577ab9d5#;
   pragma Export (C, u00146, "system__img_lliS");
   u00147 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00147, "system__img_llwB");
   u00148 : constant Version_32 := 16#5c3a2ba2#;
   pragma Export (C, u00148, "system__img_llwS");
   u00149 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00149, "system__img_wiuB");
   u00150 : constant Version_32 := 16#dad09f58#;
   pragma Export (C, u00150, "system__img_wiuS");
   u00151 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00151, "system__val_intB");
   u00152 : constant Version_32 := 16#f3ca8567#;
   pragma Export (C, u00152, "system__val_intS");
   u00153 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00153, "system__val_unsB");
   u00154 : constant Version_32 := 16#47b5ed3e#;
   pragma Export (C, u00154, "system__val_unsS");
   u00155 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00155, "system__memoryB");
   u00156 : constant Version_32 := 16#1f488a30#;
