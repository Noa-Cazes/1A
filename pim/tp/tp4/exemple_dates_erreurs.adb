...
begin
    ...
    -- Afficher_Deux_Positions (2); -- erreur, car on utilise une procédure à laquelle on a pas accès.
    New_Line;
    ...
    -- Une_Date.jour := 15;        -- erreur, car le type T_Date est un type privé.
    -- Une_Date.Mois := Mois_Suivant;   -- erreur, car le type T_Date est un type privé.
    Afficher (Une_Date);
    New_Line;
