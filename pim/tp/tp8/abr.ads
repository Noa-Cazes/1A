package ABR is
	...
	procedure Vider (Abr : in out T_ABR) with
        ...
        -- Retourner le noeaud qui contient la clé Cle
        -- Exception : Cle_Absente_Exception si la clé Cle est absente
        function Le_Noeud (Abr : in T_ABR; Cle : Character) return T_ABR;
        ...
        procedure Decrocher_Min (Abr : in out T_ABR; Min : out T_Abr) with
            Pre =>  not Est_Vide(Abr),
            Post => not Est_Vide(Min)
