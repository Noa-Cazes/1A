...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_evaluer_alea" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6f8f7528#;
   pragma Export (C, u00001, "evaluer_aleaB");
   ...
   u00152 : constant Version_32 := 16#24560dec#;
   pragma Export (C, u00152, "aleaB");
   u00153 : constant Version_32 := 16#9fe1c6b1#;
   pragma Export (C, u00153, "aleaS");
